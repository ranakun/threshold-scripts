...
var func = function (hre) {
    return __awaiter(this, void 0, void 0, function () {
        var getNamedAccounts, deployments, helpers, deployer, to1e18, KeepToken, T, KEEP_TOKEN_ALLOCATION, T_ALLOCATION_KEEP, vendingMachine;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, deployments.get("KeepToken")];
                case 2:
                    KeepToken = _a.sent();
                    return [4 /*yield*/, deployments.get("T")];
                case 3:
                    T = _a.sent();
                    KEEP_TOKEN_ALLOCATION = "940795010800000000000000000";
                    T_ALLOCATION_KEEP = to1e18("4500000000");
                    return [4 /*yield*/, deployments.deploy("VendingMachineKeep", {
