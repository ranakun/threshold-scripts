...
var func = function (hre) {
    return __awaiter(this, void 0, void 0, function () {
        var getNamedAccounts, deployments, _a, deployer, thresholdCouncil, vetoer, T, TokenStaking, TokenholderTimelock, timelock;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), deployer = _a.deployer, thresholdCouncil = _a.thresholdCouncil;
                    vetoer = thresholdCouncil !== null && thresholdCouncil !== void 0 ? thresholdCouncil : deployer;
                ...
                case 3:
                    ...
                    return [4 /*yield*/, deployments.get("TokenholderTimelock")];
                case 4:
                    TokenholderTimelock = _b.sent();
                    return [4 /*yield*/, deployments.deploy("TokenholderGovernor", {
                            from: deployer,
                            args: [
                                T.address,
