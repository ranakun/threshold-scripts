...
var func = function (hre) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var getNamedAccounts, deployments, helpers, log, deployer, KeepTokenStaking;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, deployments.getOrNull("KeepTokenStaking")];
                case 2:
                    KeepTokenStaking = _c.sent();
                    if (!(KeepTokenStaking && helpers.address.isValid(KeepTokenStaking.address))) return [3 /*break*/, 3];
                    log("using existing KeepTokenStaking at ".concat(KeepTokenStaking.address));
                    return [3 /*break*/, 6];
                case 3:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, deployments.deploy("KeepTokenStaking", {
