...
var func = function (hre) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var getNamedAccounts, deployments, helpers, log, deployer, KeepRegistry;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, deployments.getOrNull("KeepRegistry")];
                case 2:
                    KeepRegistry = _c.sent();
                    if (!(KeepRegistry && helpers.address.isValid(KeepRegistry.address))) return [3 /*break*/, 3];
                    log("using existing KeepRegistry contract at ".concat(KeepRegistry.address));
                    return [3 /*break*/, 6];
                case 3:
                ...
                case 4:
                    ...
                    return [4 /*yield*/, deployments.deploy("KeepRegistry", {
