...
var func = function (hre) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var getNamedAccounts, deployments, helpers, log, deployer, NuCypherStakingEscrow;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, deployments.getOrNull("NuCypherStakingEscrow")];
                case 2:
                    NuCypherStakingEscrow = _c.sent();
                    if (!(NuCypherStakingEscrow &&
                        helpers.address.isValid(NuCypherStakingEscrow.address))) return [3 /*break*/, 4];
                    log("using existing NuCypherStakingEscrow at ".concat(NuCypherStakingEscrow.address));
                    // Save deployment artifact of external contract to include it in the package.
                    return [4 /*yield*/, deployments.save("NuCypherStakingEscrow", NuCypherStakingEscrow)];
                case 3:
                    // Save deployment artifact of external contract to include it in the package.
                    _c.sent();
                    return [3 /*break*/, 7];
                ...
                case 5:
                    ...
                    return [4 /*yield*/, deployments.deploy("NuCypherStakingEscrow", {
