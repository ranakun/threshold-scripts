...
var func = function (hre) {
    return __awaiter(this, void 0, void 0, function () {
        var getNamedAccounts, deployments, helpers, deployer, to1e18, NuCypherToken, T, NU_TOKEN_ALLOCATION, T_ALLOCATION_NU, vendingMachine;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, deployments.get("NuCypherToken")];
                case 2:
                    NuCypherToken = _a.sent();
                    return [4 /*yield*/, deployments.get("T")];
                case 3:
                    T = _a.sent();
                    NU_TOKEN_ALLOCATION = "1380688920644254727736959922";
                    T_ALLOCATION_NU = to1e18("4500000000");
                    return [4 /*yield*/, deployments.deploy("VendingMachineNuCypher", {
