...
var func = function (hre) {
    return __awaiter(this, void 0, void 0, function () {
        var getNamedAccounts, deployments, deployer, KeepTokenStaking, KeepStake;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, deployments.get("KeepTokenStaking")];
                case 2:
                    KeepTokenStaking = _a.sent();
                    return [4 /*yield*/, deployments.deploy("KeepStake", {
                            from: deployer,
                ...
                case 3:
                    KeepStake = _a.sent();
                    if (!hre.network.tags.tenderly) return [3 /*break*/, 5];
